...
set val(ant)          Antenna/OmniAntenna        ;# modelo de andena
set val(ifqlen)      50                         ;# paquete maximo en ifq
set val(nn)          5                         ;# numero de nodos mobiles
set val(rp)          AODV                       ;# protocolo de ruteo
set val(x)           50
set val(y)           50
set opt(err)        UniformErrorProc

set val(nam)                topologia.nam
...
set tracefd     [open ./topologia.tr w]
$ns_ trace-all $tracefd
if { "$val(nam)" == "topologia.nam" } {
...
$ns_ at 0.0  "$node_(1) sscs startPANCoord 2 $BO $SO"  ;# startPANCoord
$ns_ at 0.0  "$node_(3) sscs startPANCoord 3 $BO $SO"  ;# startPANCoord <txBeacon=1> <BO=3> <SO=3>
$ns_ at 5  "$node_(1) sscs startDevice 0 0 0 $BO $SO"

Mac/802_15_4 wpanNam PlaybackRate 3ms
$ns_ at 50 "puts \"\nTransmitting data ...\n\""

##tipo de trafico y tasa de transmision 
